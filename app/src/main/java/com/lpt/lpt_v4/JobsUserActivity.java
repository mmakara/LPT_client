...
public class JobsUserActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jobs_user);
        get_local_technicians();
    }

    private void get_local_technicians() {
        String url = "http://lpt.mycibox.com/api/get-local-techs/user_id";
